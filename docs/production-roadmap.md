...
`run_events`, sin instrumentación nueva. Cada rechazo de admisión queda
registrado sin identificadores de usuario y con la profundidad y capacidad de
la cola.
...
cola global y una capacidad de modelo global. Quedan pendientes los timeouts
por turno y por corrida, la detección del modelo caído antes de admitir y la
pausa administrativa de admisión.
...
2. Medir uno, dos y más slots en el servidor operativo para fijar la
   concurrencia inicial con datos de memoria y latencia.
3. Añadir métricas de capacidad global, recuperación de leases, timeouts y una
   línea de operación para varios procesos web.
